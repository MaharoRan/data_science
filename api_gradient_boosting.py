...
# Chemin du modèle Gradient Boosting
MODEL_PATH = "gradient_boosting_california.pkl"
model = joblib.load(MODEL_PATH)

# Appel de FastAPI pour créer l'API de prédiction de productivité des salariés
app = FastAPI(title="Productivity Prediction API — Gradient Boosting", version="1.0")
...
# Requete pour la prédiction du score de productivité réel du salarié
@app.post("/predict")
